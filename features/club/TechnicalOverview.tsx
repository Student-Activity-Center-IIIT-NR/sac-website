...
const clubs = [
  { name: "// TSOC", url: "/clubs/tsoc", color: "#7AA2F7" },
  { name: "// AIML", url: "/clubs", color: "#73DACA" },
  { name: "// CipherCell", url: "/clubs", color: "#F7768E" },
  { name: "// Inquizitive", url: "/clubs", color: "#BB9AF7" },
  { name: "// Comet", url: "/clubs", color: "#FF9E64" },
];
