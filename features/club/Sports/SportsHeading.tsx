...
import AtharvLogo from "../../../assets/AtharvGallery/Atharv_logo.png";


const SportsHeading = () => {
  return (
  <>
   <Stack direction={"row"} textAlign="right" maxWidth="lg" justifyContent="space-between" mx="auto" height="350px">
