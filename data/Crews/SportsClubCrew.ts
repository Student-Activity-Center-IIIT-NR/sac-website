...
export const atharv: CrewProps[] = [
    {
        img: Arnav_Pandey,
        name: "Arnav Pandey",
        post: "Atharv Head (Boys)",
    },
    {
        img: Apurva_Sahu,
        name: "Apurva Sahu",
        post: "Atharv Head (Girls)",
    },
    {
        img: Mitesh_Pherwani,
        name: "Mitesh Pherwani",
        post: "Atharv Vice-Head",
    },
    {
        img: Nitish_Dubey,
        name: "Nitish Dubey",
        post: "Atharv Cricket InCharge (Boys)",
    },
    {
        img: Male,
        name: "K.Nitheesh Kumar",
        post: "Atharv Cricket InCharge (Boys)",
    },
    {
        img: Palak_Maheshwari,
        name: "Palak Maheshwari",
    ...
    },
    {
        img: Aditya_Singh,
        name: "Aditya Singh",
        post: "Atharv Table Tennis InCharge (Boys)",
    },
    {
        img: Palak_Maheshwari,
        name: "Palak Maheshwari",
    ...
    },
    {
        img: Adarsh_Raj,
        name: "Adarsh Raj",
        post: "Atharv Volleyball InCharge (Boys)",
    },
    {
        img: Female,
        name: "Sakshi Sonkar",
